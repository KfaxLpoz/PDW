                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="dropdown">
                            ...
                            <asp:DropDownList ID="ddlEstadoCivil" runat="server" ForeColor="White"
                                CssClass="selectpicker btn btn-secondary" Width="610px" Height="38px" DataSourceID="ldsEstado" DataTextField="strValor" DataValueField="id">
                            </asp:DropDownList>

                            <asp:LinqDataSource ID="ldsEstado" runat="server" ContextTypeName="UTTT.Ejemplo.Linq.Data.Entity.DcGeneralDataContext" EntityTypeName="" Select="new (id, strValor)" TableName="EstadoCivil">
                            </asp:LinqDataSource>
